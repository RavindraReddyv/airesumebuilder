...
// Use relative path in development, absolute URL in production
const BASE_URL = import.meta.env.MODE === 'development' ? '/api' : (import.meta.env.VITE_API_URL || 'http://localhost:5000/api');
